...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex justify-center items-center glass-bg">
      <form className="glass-card p-8 rounded-2xl shadow-lg w-full max-w-md flex flex-col items-center" onSubmit={handleRegister}>
        <div className="mb-4 flex flex-col items-center">
          <LogoSVG />
          <h2 className="text-2xl font-bold mt-2 mb-1 tracking-tight">Register</h2>
          <p className="text-gray-400 text-sm mb-2">Create your CloudTasker account</p>
        </div>
        <input
          type="text"
          placeholder="Name"
